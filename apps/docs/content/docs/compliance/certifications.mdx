...
| SOC 2          | Controls aligned to the Type II control set |
| ISO 27001      | Enterprise engagement                       |
| HIPAA          | Enterprise engagement                       |
...
<Callout type="info">Status: [Controls aligned to the Type II control set](https://esign.hanzo.ai/trust)</Callout>
...
Controls aligned to the SOC 2 Type II control set — encryption in transit and at rest, role-based access control, and audit logging. We run continual internal audits, and the report is available on request.

Formal certification is part of an enterprise engagement.

Tell us what your procurement needs — SOC 2 Type II, ISO 27001, or HIPAA with a BAA.

## ISO 27001

<Callout type="info">Status: [Enterprise engagement](https://esign.hanzo.ai/trust)</Callout>
